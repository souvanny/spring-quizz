...
//        System.out.println(payload.get("answers").getClass());
        ...
        for (int i = 0; i < answers.size(); i++) {
            ...
            QuizzAnswer modelA = new QuizzAnswer(idQuestion, (int) answer.get("isCorrect"), (String) answer.get("title"));
    ...
    @GetMapping("quizz")
    public List<QuizzQuestion> getQuizz() {
        System.out.println("list ...........................");


        List<QuizzQuestion> list = this.quizzQuestionRepository.findAll();
        System.out.println(list);
